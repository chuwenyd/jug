...
# 4. 结果可视化
def visualize_results(results, predictions, y_test, features, models, scaler):
    """可视化模型性能和预测结果"""
    # 1. 性能指标对比
...
def main():
    ...
    # 可视化结果
    visualize_results(results, predictions, y_test, features, models, scaler)
